...
const SingleVideo = ({type,id,addedAt}) => {
  ...
  const {setYtStoredVideos,setVimeoStoredVideos} = useContext(VideoContext)
  ...
  return (
    <div>
      ...
      <div className={styles.icons}><AiFillEye /> <FaTrashAlt onClick={deleteHandler} /> <AiOutlineStar/> </div>
    </div>
  )
}
